var socket = require('socket.io-client')("http://34.71.248.58:3000");
socket.on('connect', function(){
    console.log("connect!");
    // socket.emit("request.user.trips", "11");
    // socket.emit("request.user.report", "{\"reporterId\": 1, \"tripId\": 74, \"userId\": 11, \"date\":\"2019-10-13T18:54:06Z\"}");
